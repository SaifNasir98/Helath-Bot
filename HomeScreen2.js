    ...
    render() {
        ...
        return(
            <View style={styles.wrapper}>
                ...
                <Image style={styles.img2} source = {require('F:/React Codes/ExpoUI02/assets/bg5.png')} />
                <Text style={styles.txt1}> When are you available </Text>
                <Text style={styles.txt2}> for therapy? </Text>
                ...
                width: 300}} onPress={() => this._onPress()} >
                    <Text style={{fontSize: 20, fontWeight: "300", color: txtColor}} > Weekday Early Mornings </Text>
                </TouchableOpacity>
                ...
                width: 300}} onPress={() => this._onPress1()} >
                    <Text style={{fontSize: 20, fontWeight: "300", color: txtColor1}} > Weekdays ( Mornings & Afternoons ) </Text>
                </TouchableOpacity>

                <TouchableOpacity style={{padding: 15, marginHorizontal: 10, marginTop: 5,
                borderRadius: 20, backgroundColor: btnBg2, justifyContent: 'center', alignItems: 'center',
                width: 300}} onPress={() => this._onPress2()} >
                    <Text style={{fontSize: 20, fontWeight: "300", color: txtColor2}} > Weekday Evenings ( 5PM or Later ) </Text>
                </TouchableOpacity>

                <TouchableOpacity style={{padding: 15, marginHorizontal: 10, marginTop: 5,
                borderRadius: 20, backgroundColor: btnBg3, justifyContent: 'center', alignItems: 'center',
                width: 300}} onPress={() => this._onPress3()} >
                    <Text style={{fontSize: 20, fontWeight: "300", color: txtColor3}} > Weekends </Text>
                </TouchableOpacity>
